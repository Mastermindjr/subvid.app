...
export const ui = {
  en: {
    ...
    batch: {
      ...
      addFolder: "Add current folder",
      addFolderTitle: "Add the whole current folder to the queue",
    ...
    editor: {
      ...
      formatMp4: "MP4 · burned-in",
      formatWebm: "WebM · burned-in",
  ...
  es: {
    ...
    batch: {
      ...
      addFolder: "A\u00f1adir carpeta actual",
      addFolderTitle: "A\u00f1adir la carpeta actual completa a la cola",
    ...
    editor: {
      ...
      formatMp4: "MP4 · incrustados",
      formatWebm: "WebM · incrustados",
