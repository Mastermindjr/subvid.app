...
export const ui = {
  en: {
    ...
    batch: {
      open: "Batch process with the local engine",
      title: "Batch processing (local engine)",
      close: "Close",
      up: "Go to parent folder",
      addFolder: "Add this folder to the queue",
      selectedTitle: "Queue",
      mode: "Output",
      ...
      task: "Subtitles",
      taskOriginal: "Original language",
      taskEnglish: "Translated to English",
      toLangs: "Extra subtitle languages (local translation, Ctrl+click for several)",
  ...
  es: {
    ...
    batch: {
      open: "Procesar en lote con el motor local",
      title: "Procesado por lotes (motor local)",
      close: "Cerrar",
      up: "Subir a la carpeta superior",
      addFolder: "A\u00f1adir esta carpeta a la cola",
      selectedTitle: "Cola",
      mode: "Salida",
      ...
      task: "Subt\u00edtulos",
      taskOriginal: "Idioma original",
      taskEnglish: "Traducidos al ingl\u00e9s",
      toLangs: "Idiomas de subt\u00edtulos extra (traducci\u00f3n local, Ctrl+clic para varios)",
